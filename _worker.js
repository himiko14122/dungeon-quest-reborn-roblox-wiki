// Cloudflare Worker entry for Anime Origins Wiki
...
//   - /en/... and /{pt,es,fr}/... served directly
...
// IndexNow key for dungeon-quest-reborn-roblox.wiki: eb848db832a976d2a99b0c5523698687
const INDEXNOW_KEY = 'eb848db832a976d2a99b0c5523698687';
const HOST = 'www.dungeon-quest-reborn-roblox.wiki';
...
async function handleIndexNow(request) {
  ...
  if (request.method === 'GET') {
    ...
    const categories = [
      'guides', 'codes', 'tier-list', 'units', 'traits',
      'summoning', 'game-modes', 'raids', 'evolution', 'updates',
    ];
    const allUrls = [];
