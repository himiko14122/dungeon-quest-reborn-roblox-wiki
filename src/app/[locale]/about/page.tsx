...
import { getAlternates, getBaseMetadata } from '@/lib/seo';
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getAlternates('/about', validLocale),
    keywords: ['Dungeon Quest Reborn Wiki', 'Dungeon Quest Reborn about', 'Dungeon Quest Reborn community wiki', 'Dungeon Quest Reborn fan wiki', 'Dungeon Quest Reborn Roblox tower defense'],
  };
}
      ...
      <section className="mb-10">
        ...
        <div className="card mb-6">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <a href={EXTERNAL_LINKS.roblox} target="_blank" rel="noopener noreferrer" title={t('about_playSteam')} className="card text-center hover:border-[var(--color-accent)] transition-colors">
