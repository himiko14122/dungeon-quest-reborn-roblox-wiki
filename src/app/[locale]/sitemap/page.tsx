...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getAlternates('/sitemap', validLocale),
  };
}

const CATEGORY_LABEL_KEYS: Record<string, string> = {
  guides: 'nav_guides',
  factions: 'nav_factions',
  weapons: 'nav_weapons',
  'base-building': 'nav_baseBuilding',
  crafting: 'nav_crafting',
  combat: 'nav_combat',
  'skills-perks': 'nav_skillsPerks',
  'zombie-horde': 'nav_zombieHorde',
  stealth: 'nav_stealth',
  mods: 'nav_mods',
  economy: 'nav_economy',
  walkthrough: 'nav_walkthrough',
};
