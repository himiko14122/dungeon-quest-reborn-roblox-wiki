...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getAlternates('/terms-of-service', validLocale),
    keywords: ['Dungeon Quest Reborn Wiki Terms of Service', 'Dungeon Quest Reborn terms', 'Dungeon Quest Reborn usage terms'],
  };
}
