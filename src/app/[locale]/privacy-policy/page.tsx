...
import { getBaseMetadata, getAlternates } from '@/lib/seo';
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getAlternates('/privacy-policy', validLocale),
    keywords: ['Dungeon Quest Reborn Wiki Privacy Policy', 'Dungeon Quest Reborn privacy', 'Dungeon Quest Reborn data collection'],
  };
}
